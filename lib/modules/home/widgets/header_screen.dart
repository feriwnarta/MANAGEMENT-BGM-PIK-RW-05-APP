  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        (!isEmOrCord) ? carouselNews() : SizedBox(),
      ],
    );
  }

  FutureBuilder<List<CardNews>> carouselNews() {
    return FutureBuilder<List<CardNews>>(
          ...
          builder: (BuildContext context) {
            return Shimmer.fromColors(
              ...
              child: Container(
                ...
                margin: EdgeInsets.symmetric(
                  horizontal:
                      (5 / Sizer.slicingWidth) * SizeConfig.widthMultiplier,
                ),
              ),
            );
          },
