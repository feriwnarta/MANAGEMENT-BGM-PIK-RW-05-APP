...
class LaporanSelesaiManagerContractor extends StatefulWidget {
  LaporanSelesaiManagerContractor({Key key, this.name, this.status})
      : super(key: key);
...
class _CardReportFinish extends State<LaporanSelesaiManagerContractor>
