...
class PeduliLingkunganCord extends StatefulWidget {
  const PeduliLingkunganCord({Key key}) : super(key: key);

  @override
  State<PeduliLingkunganCord> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<PeduliLingkunganCord> {
              ...
              Row(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Get.to(
                        () => CardReportFinish(status: 'SELESAI'),
                        transition: Transition.cupertino,
                      );
                    },
                    child: SizedBox(
