...
import 'package:aplikasi_rw/modules/pengurus/controllers/controller_pengurus.dart';
...
class StatusPeduliLingkunganPengurus extends StatefulWidget {
  const StatusPeduliLingkunganPengurus({Key key}) : super(key: key);

  @override
  State<StatusPeduliLingkunganPengurus> createState() =>
      _ListStatusPeduliLingkunganState();
}

class _ListStatusPeduliLingkunganState
    extends State<StatusPeduliLingkunganPengurus> {
  ...
  final controllerEm = Get.put(ListStatusPeduliPengurusController());
  ...
  void initState() {
    super.initState();
    future = StatusPeduliPengurusServices.listMasterCategory();
  ...
  void dispose() {
    ...
    Get.delete<ListStatusPeduliPengurusController>();
    super.dispose();
  }
                          ...
                          () => (controllerEm.isLoading.value)
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) => (controllerEm
                                      ...
                                      ? Column(
                                          children: [
                                            CardStatusPeduliLingkunganPengurus(
...
class CardStatusPeduliLingkunganPengurus extends StatelessWidget {
  CardStatusPeduliLingkunganPengurus({
    Key key,
    this.title,
    this.status,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () async {
        ...
        var rs = await StatusPeduliPengurusServices.getDataReportCard(
            idReport: idReport);
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              width: SizeConfig.width(157),
              height: SizeConfig.height(32),
              child: ElevatedButton(
                onPressed: () {
                  Get.defaultDialog(
                    title: 'Pilih Estate Manager',
                    radius: 5,
