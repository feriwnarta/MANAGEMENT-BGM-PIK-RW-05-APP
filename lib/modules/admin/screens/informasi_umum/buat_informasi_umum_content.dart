...
import 'package:aplikasi_rw/modules/admin/screens/informasi_umum/buat_informasi_umum_detail.dart';
import 'package:aplikasi_rw/utils/size_config.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class BuatInformasiUmumContent extends StatelessWidget {
  BuatInformasiUmumContent({Key key}) : super(key: key);
                    ...
                    ElevatedButton(
                      onPressed: () {
                        if (_formKey.currentState.validate()) {
                          Get.to(() => BuatInformasiUmumDetail());
                        }
                      },
